...
export default memo(function TranslationPanel() {
  ...
  return (
    <div className={`bg-white max-h-[30vh] sm:max-h-[35vh] md:max-h-[40vh] overflow-auto ${showTranslation ? 'border-t' : ''}`}>
        ...
        <div className="px-3 sm:px-4 py-3">
          ...
          <div>
            ...
            {isTranslating ? (
              ...
              <p className="text-sm text-gray-900 bg-blue-50 rounded-lg p-2 max-h-32 sm:max-h-48 overflow-auto leading-relaxed">
