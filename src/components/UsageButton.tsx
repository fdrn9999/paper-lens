...
export default function UsageButton() {
  ...
  return (
    <div className="relative shrink-0" ref={panelRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-[calc(100vw-2rem)] sm:w-64 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 overflow-hidden animate-in fade-in">
