...
import { detectInjection, detectHistoryInjection, detectOutputLeak } from '@/lib/injectionFilter';
...
// Overall server-side deadline for the Gemini call, kept under the client's 60s timeout.
const CHAT_GEMINI_TIMEOUT_MS = 55000;
